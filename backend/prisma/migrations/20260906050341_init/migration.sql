-- CreateEnum
CREATE TYPE "Role" AS ENUM ('GUEST', 'CUSTOMER', 'USER', 'ADMIN');
...
-- CreateIndex
CREATE UNIQUE INDEX "ReviewImage_reviewId_fileId_key" ON "ReviewImage"("reviewId", "fileId");
...
-- AddForeignKey
ALTER TABLE "ReviewImage" ADD CONSTRAINT "ReviewImage_fileId_fkey" FOREIGN KEY ("fileId") REFERENCES "File"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
